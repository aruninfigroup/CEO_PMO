 ...
 *
 *  entities  : id (text PK), label (text), section_id (text),
 *              current_focus (text), sort_order (int)
 *
 *  tasks     : id (text PK), type (text), title (text), company_id (text),
 ...
 *
 *  ideas     : id (text PK), type (text), title (text),
 *              company_id (text), notes (text)
 */
...
// ---- Sample data (mirrors src/data/sampleData.js) ----
